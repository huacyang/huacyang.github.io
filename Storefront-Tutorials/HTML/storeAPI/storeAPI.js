...
adobe.dps.Store.prototype.getFolioData = function(callback) {
	var data = [
		...
		{
			title : "Fourth issue",
			description : "This is our fourth magazine.",
			productId : "org.store.dummy.4",
			broker : "noChargeStore",
			thirdPartyEntitled : false,
			folioNumber : "1",
			publicationDate : 1332074877,
